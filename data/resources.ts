...
export const resources: ResourceItem[] = [
  ...
  {
  id: "res-backend-fundamentals",
  title: "Backend Development Fundamentals",
  category: "BACKEND",
  type: "Cheat Sheet",
  description: "Core backend concepts covering APIs, server architecture, and request handling essentials.",
  creatorOrSource: "Sonu's Lab Notes",
  link: "https://youtube.com/playlist?list=PLQnljOFTspQWGuRmwojJ6LiV0ejm6eOcs&si=3mfQAHuQCJn3t5hA",
  difficulty: "Intermediate",
  highlights: ["REST API Design", "Server-Side Architecture", "Request/Response Lifecycle"],
},
];
